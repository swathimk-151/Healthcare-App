    ...
    try {
      ...
      if (!doctorUserStr) {
        toast({
          ...
          description: "You must be logged in as a doctor to create articles.",
          variant: "destructive",
        })
        router.push("/login")
        return
      ...
      addArticle({
        ...
        authorName: doctorUser.name || "Dr. Medical Professional",
        authorType: "doctor",
      })
  ...
  return (
    <DoctorLayout>
      <div className="flex flex-col gap-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Create Medical Article</h1>
          <p className="text-gray-500 mt-2">Share your medical expertise with patients</p>
        </div>
        ...
        <Card>
          <form onSubmit={handleSubmit}>
            <CardHeader>
              ...
              <CardDescription>Fill in the information for the new medical article</CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex justify-between">
              ...
              >
                {isSubmitting ? "Publishing..." : "Publish Medical Article"}
              </Button>
            </CardFooter>
          </form>
        </Card>
